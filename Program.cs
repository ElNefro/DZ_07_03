namespace DZ_07_03
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            cars.Add(new Car("4324231", "Toyata", "Chaiser", 1978, "Blue"));
            cars.Add(new Car("5423523", "Mercedes", "s63 amg v223", 2024, "Gray"));
            cars.Add(new Car("5234252", "Haval", "H9", 2022, "Red"));
            cars.Add(new Car("6524346", "Micubishi", "Outlander", 2017, "Blue"));
            cars.Add(new Car("5436234", "Renoult", "Logan", 2006, "White"));
            ...
            employees.Add(new Employee("Сагадеев", "Ян", "Александрович", "Менеждер", 1999));
            employees.Add(new Employee("Рампов", "Игорь", "Тигранович", "Механник", 2020));
            employees.Add(new Employee("Баринов", "Виктор", "Петрович", "Репортёр", 1980));
            employees.Add(new Employee("Замков", "Магамед", "Абдулаевич", "Уборщик", 1973));
            employees.Add(new Employee("Кожевников", "Чонгук", "Артурович", "Директор", 1996));
